...
**Note:** This is similar to Exercise 5 in the exercise list, but in Exercise 5, the rightmost value in the array is not necessarily larger than the leftmost value in the next row. 
